...
/**
 * Utility which supports seekable (byte-range) streaming any binary data over HTTP
 */
public final class HttpStreamUtil {

    private static final Logger log = LoggerFactory.getLogger(HttpStreamUtil.class);
            ...
            throws IOException
    {
        ...
        log.info("Sending " + fileName + " with " + length + "bytes...");
    ...
    private static void sendRequestedRanges(
        ...
        try {
            ...
            if (ranges.get(0).isFull()) {
                ...
                if (content) {
                    ...
                    // Copy full range.
                    copyRange(input,  Channels.newChannel(output), r);
                }
                ...
                if (content) {
                    ...
                    for (Range r : ranges) {
                        ...
                        copyRange(input, outputChannel, r);
                    }
            ...
            ChannelUtils.closeRelaxed(output);
            ChannelUtils.closeRelaxed(input);
        }
    }

    private static void copyRange(ReadableByteChannel input, WritableByteChannel output, Range r) throws IOException {

        log.debug("Sending byte range to client " + r);
        ChannelUtils.copy(input, output, r.start, r.length);
    }
     ...
     */
    private static List<Range> getRanges(HttpServletRequest request, HttpServletResponse response,
     ...
     * @throws IOException
     */
    private static boolean validateRequestHeader(HttpServletRequest request, HttpServletResponse response,
